    ...
    def get_interfaces(cls):
        ...
        for line in lines:
            ...
            if 'inet' in ls:
                ...
                assets_dict[interface]['i_ip'] = re.split(':', inet)[1]
                assets_dict[interface]['i_mask'] = re.split(':', ls[-1])[1]
...
class Services:
    ...
    def get_services(cls):
        ...
        for line in lines:
            ...
            ports_dict[proc_name] = re.split(':', full_name)[1]
...
class SSHConfig:
    ...
    def parse(cls, filename=SSH_CONFIG_FILE):
        ...
        for index, line in enumerate(lines):
            ...
            if ls[0] in config_dict:
                config_dict[ls[0]] += ' ' + ' '.join(ls[1:])
            else:
                config_dict[ls[0]] = ' '.join(ls[1:])
...
class IPTables:
    ...
    def _parse(self):
        ...
        for index, line in enumerate(lines):
            ...
            if len(line) == 0 or (not PARSE_CONF_COMMENTS and line[0] == '#') or \
